  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-2 sm:px-4 md:px-8 lg:px-16">
        ...
        >
          <h1
            className="font-MongolianBaiti 
                      text-4xl sm:text-5xl md:text-6xl lg:text-[100px] xl:text-[100px] 
                      tracking-[0.1em] sm:tracking-[0.15em] md:tracking-[0.2em] lg:tracking-[0.25em]
                      leading-tight sm:leading-snug md:leading-normal lg:leading-[1.1]
                    text-[#F2D9B6] drop-shadow-2xl
                      [text-shadow:_2px_2px_8px_rgba(0,0,0,0.3)]
                      px-4 py-6 sm:px-6 sm:py-8 md:px-8 lg:py-4
                      text-center">
            BELLA VIDA
          </h1>
